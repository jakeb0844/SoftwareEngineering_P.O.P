...
public class calendarGui{
    ...
    public static void main (String args[]){
        ...
        //Populate table
        //This if for the drop down box they have
        //it lists the years -100 and +100 by the current year
    ...
    public static void refreshCalendar(int month, int year){
        ...
        //Clear table
        //YOu have to clear the table after each time you change the month
       for (int i=0; i<6; i++){
            for (int j=0; j<7; j++){
                mtblCalendar.setValueAt("", i, j);
            }
        }
        ...
        //the numbers are like an array[0-6] 
        int row=0;
   ...
   for(int i=1; i <= NumOfDays; i++){
    ...
    //this is the method for the color on the weekends
